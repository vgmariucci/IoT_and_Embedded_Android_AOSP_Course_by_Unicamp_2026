...
1. In a directory of your preference, clone this repo:
    ...
    ```
    If you don't want to download all the repo folders and files, you can just create a new Android Studio project and just copy the files shown in the image below from the app directory onto your project
